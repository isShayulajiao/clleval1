...
参赛队伍联系负责人需填写本次评测语料的使用权协议，并签署保密协议，扫描后通过E-mail发送给评测联系人（wangkang1@stu.ynu.edu.cn）。  
申请通过后，评测联系人将文学语料库发给给参赛队伍联系负责人，以供参赛队伍使用。该语料数据只可用于本次评测任务，不可有其他任何用途，请尊重数据标注者的成果。
