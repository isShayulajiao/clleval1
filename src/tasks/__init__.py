...
TASK_REGISTRY = {
    ...
    "ZM_critpred": zhengming.CritPred,
    "ZM_aclue": zhengming.ACLUE,
    "ZM_readcom": zhengming.ReadCom,
    "ZM_authide": zhengming.AuthIDE,
    "ZM_litner": zhengming.LitNRE,
    "ZM_clatrans": zhengming.ClaTrans,
