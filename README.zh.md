...
2. [任务介绍](#任务介绍)  
    2.1 [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)  
        ...
        2.1.2 [数据样例](#数据样例)  
        2.1.3 [评价标准](#评价标准)
    2.2 [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)  
        2.2.1 [任务内容](#任务内容)  
        2.2.2 [数据样例](#数据样例)  
        2.2.3 [评价标准](#评价标准)
   2.3 [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)  
        2.3.1 [任务内容](#任务内容)  
        2.3.2 [数据样例](#数据样例)  
        2.3.3 [评价标准](#评价标准)
   2.4 [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)  
        2.4.1 [任务内容](#任务内容)  
        2.4.2 [数据样例](#数据样例)  
        2.4.3 [评价标准](#评价标准)
   2.5 [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)  
        2.5.1 [任务内容](#任务内容)  
        2.5.2 [数据样例](#数据样例)  
        2.5.3 [评价标准](#评价标准)
   2.6 [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)  
        2.6.1 [任务内容](#任务内容)  
        2.6.2 [数据样例](#数据样例)  
        2.6.3 [评价标准](#评价标准)
   2.7 [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)  
        2.7.1 [任务内容](#任务内容)  
        2.7.2 [数据样例](#数据样例)  
        2.7.3 [评价标准](#评价标准)  
3. [模型评测](#模型评测)  
