...
1. [评测背景](#评测背景)
2. [任务介绍](#任务介绍)
    1. [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)
        1. [任务内容](#任务内容)
        2. [数据样例](#数据样例)
        3. [评价标准](#评价标准)
    2. [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)
        1. [任务内容](#任务内容)
        2. [数据样例](#数据样例)
        3. [评价标准](#评价标准)
    3. [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)
        1. [任务内容](#任务内容)
        2. [数据样例](#数据样例)
        3. [评价标准](#评价标准)
    4. [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)
        1. [任务内容](#任务内容)
        2. [数据样例](#数据样例)
        3. [评价标准](#评价标准)
    5. [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)
        1. [任务内容](#任务内容)
        2. [数据样例](#数据样例)
        3. [评价标准](#评价标准)
    6. [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)
        1. [任务内容](#任务内容)
        2. [数据样例](#数据样例)
        3. [评价标准](#评价标准)
    7. [现代文学批评倾向(OA1)](#现代文学批评倾向oa1)
        1. [任务内容](#任务内容)
        2. [数据样例](#数据样例)
        3. [评价标准](#评价标准)
3. [模型评测](#模型评测)
