...
1. [评测背景](#1评测背景)  
2. [任务介绍](#2任务介绍)  
    2.1 [现代文学批评倾向(OA1)](#2.1现代文学批评倾向oa1)  
        2.1.1 [任务内容](#2.1.1任务内容)  
        2.1.2 [数据样例](#2.1.2数据样例)  
        2.1.3 [评价标准](#2.1.3评价标准)  
3. [模型评测](#3模型评测)  
4. [评测赛程](#评测赛程)  
5. [奖项设置](#奖项设置)  
6. [撰写技术报告](#撰写技术报告)  
...
![现代文学批评挖掘]([pictures/oa2.jpg](https://github.com/isShayulajiao/clleval1/blob/main/oa1.png))
